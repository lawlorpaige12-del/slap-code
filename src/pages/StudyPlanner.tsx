...
import { generatePlan, fetchSavedPlan, fetchCalendarEntries, PlannerInput, PlanTask } from '../services/api';
  ...
  return (
    <section className="section-grid" aria-label="AI study planner">
      ...
      <form className="card planner-form" onSubmit={handleGenerate}>
        ...
        <label>
          Weekly availability
          <input value={weeklyAvailability} onChange={(event) => setWeeklyAvailability(event.target.value)} />
        </label>
